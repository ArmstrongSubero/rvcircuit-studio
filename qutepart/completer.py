...
from PySide6.QtCore import Signal, QAbstractItemModel, QEvent, QModelIndex, QObject, QSize, Qt, QTimer
...
class _CompletionList(QListView):
    ...
    def __init__(self, qpart, model):
        ...
        palette.setColor(QPalette.ColorGroup.Inactive, QPalette.ColorRole.Highlight, palette.color(QPalette.ColorGroup.Active, QPalette.ColorRole.Highlight))
