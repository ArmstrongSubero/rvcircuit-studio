...
def _loadRegExpr(parentContext, xmlElement, attributeToFormatMap):
    try:
        ...
        _logger.error(f"An error occurred in _loadRegExpr: {e}", exc_info=True)
        raise e
        
def _loadAbstractNumberRule(rule, parentContext, xmlElement, attributeToFormatMap):
